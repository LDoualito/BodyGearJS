...
Par défaut, Supabase demande une confirmation par email lors de l'inscription. Vous avez deux options :
1.  **Option A (Recommandée pour le dev)** : Désactiver la confirmation.
    - Allez dans votre dashboard Supabase > Authentication > Providers > Email.
    - Décochez "Confirm email".
2.  **Option B** : Vérifiez vos emails (et spams) et cliquez sur le lien de confirmation.
